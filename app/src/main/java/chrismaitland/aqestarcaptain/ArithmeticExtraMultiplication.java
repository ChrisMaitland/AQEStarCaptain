...
public class ArithmeticExtraMultiplication extends ArithmeticMultiplication {

    int operand3;
    char operator2;

    public ArithmeticExtraMultiplication() {
        super();
        setOperator2('-');
    ...
    public ArithmeticExtraMultiplication(Difficulty difficulty) {
        super(difficulty);
        setOperator2('-');
        
        int third;
        
        //Easy: An Easy Multiplication question with a number between 1 and 10 taken away
    	//Medium: A Medium Multiplication question with a number between 1 and 50 taken away
    	//Hard: A Hard Multiplication question with a number between 1 and 100 taken away
        switch (difficulty) {
	        case Easy: 
     ...
     * @param the answer
     */
    public ArithmeticExtraMultiplication(Difficulty difficulty, String question, String answer) {
