...
public class ArithmeticAdditionTest extends TestCase {

    ArithmeticAddition easyQuestion;
    ArithmeticAddition mediumQuestion;
    ArithmeticAddition hardQuestion;

    public void setUp() throws Exception {
        super.setUp();
        easyQuestion = new ArithmeticAddition(Difficulty.Easy);
        easyQuestion.generateAnswer();
        mediumQuestion = new ArithmeticAddition(Difficulty.Medium);
        mediumQuestion.generateAnswer();
        hardQuestion = new ArithmeticAddition(Difficulty.Hard);
    ...
    public void testGenerateOperandDivisibleBy_EasyQuestion() throws Exception {
        ...
        double second = easyQuestion.generateOperand(1, 99);
    ...
    public void testGenerateOperandDivisibleBy_MediumQuestion() throws Exception {
        ...
        double second = mediumQuestion.generateOperand(10, 9999);
    ...
    public void testGenerateOperandWith2DecimalPlaces_HardQuestion() throws Exception {
        ...
        double second = hardQuestion.generateOperandWith2DecimalPlaces(10, 9999);
    ...
    private void validateEasy(ArithmeticAddition question) {
        //difficulty Easy
    ...
    private void validateEasyOperands(double operand1, double operand2, double result) {
        ...
        //result between 1 and 198 and is operand1 + operand2
        assertTrue(result >= 1 && result <= 198 && result == operand1 + operand2);
    }
    ...
    private void validateEasyOperands(double operand1, double operand2) {
        ...
        //operand2 between 1 and 99
        assertTrue(operand2 >= 1 && operand2 <= 99);
    }

    private void validateMedium(ArithmeticAddition question) {
        //difficulty Easy
        Difficulty difficulty = question.getDifficulty();
    ...
    private void validateMediumOperands(double operand1, double operand2, double result) {
        ...
        //result between 110 and 19998 and is operand1 + operand2
        assertTrue(result >= 110 && result <= 19998 && result == operand1 + operand2);
    }
    ...
    private void validateMediumOperands(double operand1, double operand2) {
        ...
        //operand2 10 and 9999
        assertTrue(operand2 >= 10 && operand2 <= 9999);
    }

    private void validateHard(ArithmeticAddition question) {
        //difficulty Hard
        Difficulty difficulty = question.getDifficulty();
    ...
    private void validateHardOperands(double operand1, double operand2, double result) {
        ...
        //result between 20 and 19998 and is operand1 + operand2
        //and the result has 2 decimal places or fewer
        assertTrue(result >= 20 && result <= 19998 && result == operand1 + operand2);
    ...
    private void validateHardOperands(double operand1, double operand2) {
        ...
        //operand2 between 10 and 9999 with up to 2 decimal places
        assertTrue(operand2 >= 10 && operand2 <= 9999);
    ...
    private void validate(ArithmeticAddition question, double operand1, double operand2, double result) {
